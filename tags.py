...
my_url = 'https://www.goodreads.com/quotes'
...
tags_container = right_container.find(
    "div", {"class": "bigBoxContent containerWithHeaderContent"})
# print(right_container)
all_tags = tags_container.find_all("a", {"class": "gr-hyperlink"})
# print(all_tags)
# prepare CSV
file = "tags.csv"
header = "id, name, link \n"
...
for tags in all_tags:
    name = tags.text.replace("Quotes", '').strip()
    link = tags.get("href")
